                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="ltn__drop-menu ltn__currency-menu ltn__language-menu">
                                            <ul>
                                                <li><a href="#" class="dropdown-toggle"><span class="active-currency">Language</span></a>
                                                    <ul>
                                                        <li><a href="#">en</a></li>
                                                        <li><a href="#">ru</a></li>
                                                        <li><a href="#">uz</a></li>
                                    ...
                                    <ul>
                                        ...
                                        <li class="menu-icon"><a href="{{ route('about') }}">About</a>
                                            <ul>
                                                ...
                                                <li><a href="{{route('portfolio')}}">Portfolio - 02</a></li>
                                                <li><a href="{{route('locations')}}">Google Map Locations</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-icon"><a href="{{route('shop')}}">Shop</a>
                                            <ul>
                                                ...
                                                <li><a href="{{route('home')}}">Other Pages <span class="float-end">>></span></a>
                                                    <ul>
                                        ...
                                        <li class="menu-icon"><a href="{{route('news')}}">News</a></li>
                                        <li class="menu-icon"><a href="{{route('home')}}">Pages</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li><a href="{{route('home')}}">Inner Pages</a>
                                                    <ul>
                                                        <li><a href="{{route('cart')}}">Cart</a></li>
                                                        <li><a href="{{route('checkout')}}">Checkout</a></li>
                                                        <li><a href="{{route('account')}}">My Account</a></li>
